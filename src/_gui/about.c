...
#ifdef _M_X64
#  define TFTPD_STRING   "TFTPD64 v4.73 Build " __DATE__ " " __TIME__
#  define TFTPD_ABOUT_TITLE   "About TFTPD64"
#else
#ifndef TFTP_CLIENT_ONLY
#     define TFTPD_STRING   "TFTPD32 v4.73 Build " __DATE__ " " __TIME__
#else
...
#  ifdef _M_X64
const char LICENSE_TFTPD32 [] =
"Tftpd64 Service Edition copyrighted 2007-2025 by Philippe Jounin\r\n";
#  else
const char LICENSE_TFTPD32 [] =
"Tftpd32 Service Edition copyrighted 2007-2025 by Philippe Jounin\r\n";
#  endif
#endif
